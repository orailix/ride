"""Build the model-specific Gold tabular dataset from a Silver release and Gold core."""
...
def main() -> None:
    """Parse CLI arguments and launch Gold tabular dataset construction."""
    parser = argparse.ArgumentParser(
        description=(
            "Build the model-specific Gold tabular dataset. "
            "Outputs are train/test arrays plus scheme and normalization metadata."
        )
    )
