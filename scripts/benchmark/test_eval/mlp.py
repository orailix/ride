"""Run repeated train+eval for the MLP benchmark model.

This wrapper resolves the fixed benchmark config, retrains the MLP once per
...
def _hidden_dims_arg(value: Any) -> str:
    """Normalize YAML hidden-dimension values for the training script CLI."""
