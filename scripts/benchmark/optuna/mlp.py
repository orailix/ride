"""Run Optuna hyperparameter search workers for the MLP benchmark model.

Each trial launches the regular MLP training script in a per-trial directory,
...
def suggest_hparams(
    ...
    """Sample and validate the MLP training hyperparameters for one trial."""
...
def build_train_command(
    *,
    ...
    """Build the CLI command for the regular MLP training entry point."""
