"""Run Optuna hyperparameter search workers for the GNN benchmark model.

Each trial launches the regular GNN training script in a per-trial directory,
...
def suggest_hparams(trial: optuna.Trial, args: argparse.Namespace) -> dict[str, int | float | str | bool]:
    """Sample and validate the GNN training hyperparameters for one trial."""
...
def build_train_command(
    *,
    ...
    """Build the CLI command for the regular GNN training entry point."""
