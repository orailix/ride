"""Gold sequential dataset construction utilities."""
...
def build_feature_rows(
    *,
    ...
    """Expand active snapshots into raw feature rows before sequence export."""
...
def build_ordered_feature_table(
    *,
    ...
    """Order the feature table columns according to the exported sequential schema."""
    metric_order = {
        "distance": 0,
        "nb_of_trains": 1,
        "avg_delay": 2,
...
def _build_lstm_column_scheme(
    *,
    ...
    """Build the column grouping scheme used to export LSTM arrays."""
...
def _extract_lstm_arrays_from_split_df(
    *,
    ...
    """Extract static, past-sequence, and future-known arrays from one split."""
...
def prepare_sequential_build_context(
    *,
    ...
    """Load shared inputs and indexes needed for the sequential build."""
...
def normalize_and_export(
    *,
    ...
    """Apply normalization and export final train/test sequential arrays."""
...
def build_and_export_streaming(
    *,
    ...
    """Build and export the sequential dataset with two-pass streaming."""
...
def build_sequential_dataset(
    *,
    ...
    """Build the Gold sequential dataset from a Silver dataset and Gold core.
    ...
    Returns:
        None. The function writes the sequential dataset under `output_dir`.
    """
